...
const translations = {
  en: {
    ...
    results_top_match_badge: 'Top Match',
    results_confidence_high: 'High Confidence',
    results_confidence_medium: 'Medium Confidence',
    results_confidence_low: 'Low Confidence',
    results_urgent_badge:  'Urgent',
    results_pregnancy_warning_badge: 'Pregnancy Warning',
    results_matched_label: 'Matched:',
    results_match_label:  'Match',
    results_symptoms_match: '{matched} of {total} symptoms match',
    results_possible_conditions: 'Possible Conditions',
    results_high_severity: 'High Severity',
    results_pregnancy_consideration: 'Pregnancy Consideration',
    results_when_to_seek_care: 'When to Seek Medical Care',
    results_causes:        'Causes',
    results_treatment:     'Treatment',
    results_recommended_tests: 'Recommended Tests at the Hospital',
    results_show_tests_hint: 'Show this list to your doctor or lab technician for confirmation:',
    results_prevention:    'Prevention',
    results_first_aid:     'First Aid Steps',
    results_home_care:     'Home Care Recommendations',
    results_warning_signs: 'Warning Signs',
    results_er_hint:       'Go to ER if you experience:',
    results_medications_avoid: 'Medications to Avoid',
    results_show_less:     'Show Less',
    results_show_more:     'Show {n} More Conditions',
    results_low_confidence_title: 'Low Confidence Analysis',
    results_low_confidence_text: 'Matches have lower confidence. Try adding more symptoms, or consult a health professional in Bamenda for a full assessment.',
    results_help_improve:  'Help Improve MediGuard',
    results_help_improve_desc: 'After visiting a health professional, let us know if the assessment was accurate. Your feedback improves accuracy for the entire Bamenda community.',
    results_actual_diagnosis_label: 'Actual diagnosis (optional — what did the doctor say?)',
    results_actual_diagnosis_placeholder: 'e.g. Malaria, Typhoid Fever…',
    results_comment_label: 'Comment (optional)',
    results_comment_placeholder: 'Any additional feedback…',
    results_yes_helpful:   'Yes, it was helpful',
    results_not_helpful:   'Not helpful',
    results_feedback_thanks: 'Feedback recorded. Thank you for helping improve MediGuard for Bamenda!',
    results_disclaimer_text: 'These results are generated by an AI algorithm matching your symptoms against a database. This is NOT a medical diagnosis. Do not disregard professional medical advice or delay seeking it because of information provided here.',
    results_pregnant_badge: 'Pregnant',
    results_pregnant_weeks: '{weeks} weeks',
    results_years:         '{age} years',
    results_severity_suffix: '{severity} severity',
    results_fatigue_context: 'Fatigue context',
    results_based_on:      'Based on your reported {n} symptom(s), our AI identified the following potential conditions.',
    results_auth_required_title: 'Authentication Required',
    results_auth_required_desc: 'Please login to save this diagnosis to your profile.',
    results_saved_title:  'Diagnosis Saved',
    results_saved_desc:   'Results successfully added to your health history.',
  ...
  fr: {
    ...
    results_read_aloud:    'Lire à Voix Haute',
    ...
    results_top_match_badge: 'Meilleure Correspondance',
    results_confidence_high: 'Confiance Élevée',
    results_confidence_medium: 'Confiance Moyenne',
    results_confidence_low: 'Confiance Faible',
    results_urgent_badge:  'Urgent',
    results_pregnancy_warning_badge: 'Avertissement Grossesse',
    results_matched_label: 'Correspondance :',
    results_match_label:  'Correspondance',
    results_symptoms_match: '{matched} sur {total} symptômes correspondent',
    results_possible_conditions: 'Conditions Possibles',
    results_high_severity: 'Gravité Élevée',
    results_pregnancy_consideration: 'Considération pour la Grossesse',
    results_when_to_seek_care: 'Quand Consulter un Médecin',
    results_causes:        'Causes',
    results_treatment:     'Traitement',
    results_recommended_tests: 'Tests Recommandés à l\'Hôpital',
    results_show_tests_hint: 'Montrez cette liste à votre médecin ou technicien de laboratoire pour confirmation :',
    results_prevention:    'Prévention',
    results_first_aid:     'Premiers Secours',
    results_home_care:     'Soins à Domicile Recommandés',
    results_warning_signs: 'Signes d\'Alerte',
    results_er_hint:       'Allez aux urgences si vous ressentez :',
    results_medications_avoid: 'Médicaments à Éviter',
    results_show_less:     'Afficher Moins',
    results_show_more:     'Afficher {n} Conditions Supplémentaires',
    results_low_confidence_title: 'Analyse à Faible Confiance',
    results_low_confidence_text: 'Les correspondances ont une confiance plus faible. Essayez d\'ajouter plus de symptômes, ou consultez un professionnel de santé à Bamenda pour une évaluation complète.',
    results_help_improve:  'Aidez à Améliorer MediGuard',
    results_help_improve_desc: 'Après avoir consulté un professionnel de santé, dites-nous si l\'évaluation était exacte. Vos retours améliorent la précision pour toute la communauté de Bamenda.',
    results_actual_diagnosis_label: 'Diagnostic réel (optionnel — qu\'a dit le médecin ?)',
    results_actual_diagnosis_placeholder: 'ex. Malaria, Fièvre Typhoïde…',
    results_comment_label: 'Commentaire (optionnel)',
    results_comment_placeholder: 'Tout autre commentaire…',
    results_yes_helpful:   'Oui, c\'était utile',
    results_not_helpful:   'Pas utile',
    results_feedback_thanks: 'Retour enregistré. Merci d\'aider à améliorer MediGuard pour Bamenda !',
    results_disclaimer_text: 'Ces résultats sont générés par un algorithme d\'IA comparant vos symptômes à une base de données. CECI N\'EST PAS un diagnostic médical. Ne négligez pas les conseils médicaux professionnels et ne retardez pas leur recherche en raison des informations fournies ici.',
    results_pregnant_badge: 'Enceinte',
    results_pregnant_weeks: '{weeks} semaines',
    results_years:         '{age} ans',
    results_severity_suffix: 'gravité {severity}',
    results_fatigue_context: 'Contexte de fatigue',
    results_based_on:      'Sur la base de vos {n} symptôme(s) signalé(s), notre IA a identifié les conditions potentielles suivantes.',
    results_auth_required_title: 'Authentification Requise',
    results_auth_required_desc: 'Veuillez vous connecter pour enregistrer ce diagnostic dans votre profil.',
    results_saved_title:  'Diagnostic Enregistré',
    results_saved_desc:   'Résultats ajoutés avec succès à votre historique de santé.',
